...
def testBuildPrimeArray():
    ...
    n=int(raw_input('Enter the number of primes to calculate: '))
    ...
    while(True):        
        ...
        if(option=='n'):
            n=int(raw_input("Input n to receive the nth prime in the sequence of primes: "))#need to type cast, since raw input returns string            
